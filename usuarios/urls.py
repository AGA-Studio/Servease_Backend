...
urlpatterns = [
    ...
    path('mfa/backup-codes/generate/', views.MfaBackupCodesGenerateView.as_view(), name='usuario-mfa-backup-generate'),
    path('mfa/backup-codes/verify/', views.MfaBackupCodeVerifyView.as_view(), name='usuario-mfa-backup-verify'),
